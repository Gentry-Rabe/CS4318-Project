...
// Determines the scope name for a new symbol
...
// Checks current scope and parent scopes for symbol, returns pointer to symbol
...
// Gets current count of entries in symbol table
